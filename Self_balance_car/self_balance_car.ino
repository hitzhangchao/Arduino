...
double kp = 30, ki = 0.0, kd = 0.5;                               //需要你修改的参数
double kp_speed = 4.2, ki_speed = 0.02, kd_speed = 0;             // 需要你修改的参数
double kp_turn = 8, ki_turn = 0, kd_turn = 0.3;                   //旋转PID设定
const double PID_Original[6] = {30, 0, 0.5, 4.2, 0.02, 0};        //恢复默认PID参数
//转向PID参数
